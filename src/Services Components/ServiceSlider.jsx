...
const services = [
    { id: 0, img: img1, color: "#00C950", title: "UI/UX Design", description: "We design intuitive and user-friendly digital experiences that improve engagement and usability.", services: ["UX Research", "Website UI Design", "Mobile App UI Design", "UX Research", "Wireframing & Prototyping", "Product Interface Design"] },
