...
const AboutHero = () => {
    return (
        <div className='md:h-auto h-full w-full relative container-p sm:pt-15 md:bg-contain bg-cover bg-right bg-black bg-no-repeat overflow-hidden' style={{ backgroundImage: `url(${isobg})` }}>
            <div className='lg:py-20 md:py-23 py-20  h-full text-white max-w-xl flex flex-col justify-center '>
