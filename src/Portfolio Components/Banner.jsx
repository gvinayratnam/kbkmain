...
const Banner = () => {
    return (
        <div className='container-p bg-black'>
            ...
            <div>
                <p className='uppercase text-xs tracking-wider font-medium'>Recent work</p>
            </div>
            <div className='flex lg:px-30 md:px-20  w-full relative'>
                <div className='flex flex-col sm:gap-20 gap-10 w-full z-1'>
                    <h1 className='lg:text-7xl sm:text-5xl text-3xl'>Creative works
                        with our incredible
                        people.
                    </h1>
