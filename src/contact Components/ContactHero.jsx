...
import astron from '../assets/contact/astron.png'
        ...
        <div className='md:h-auto h-full w-full relative container-p sm:py-30  md:bg-contain bg-cover bg-right bg-black bg-no-repeat overflow-hidden' style={{ backgroundImage: `url(${isobg})` }}>
            <div className='lg:py-20 md:py-23 sm:py-20 py-20  h-full text-white  flex flex-col justify-center '>
                <div className='flex flex-col  md:gap-10 gap-5 sm:pl-0 '>
                    <div className='relative  lg:text-8xl md:text-7xl sm:text-5xl text-3xl font-bold tracking-wide '><span className='relative z-10 tracking-wide uppercase '>Contact <img className='absolute z-1 right-1/2 md:top-5 top-0 w-13' src={dot} alt="" /> <img className='absolute z-1 lg:w-30 md:w-25 sm:w-18 w-12 -top-[50%] -right-[15%] sm:-top-[47%] sm:-right-[13%] md:-top-[40%] md:-right-[12%] lg:-top-[30%] lg:-right-[10%]' src={astron} alt="" /> </span>
                    ...
                    <div className='flex sm:flex-nowrap flex-wrap lg:gap-3'>
                        ...
                        <div className=''>
                            <p className='sm:text-md font-medium md:text-base text-sm tracking-wide sm:w-1/2 text-[#999999]'>We’re designing digital experiences that enrich
